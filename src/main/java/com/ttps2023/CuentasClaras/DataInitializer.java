...
public class DataInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (expenseCategoryRepository.count() == 0) {
			ExpenseCategory ec1 = new ExpenseCategory("Combustible", null);
			ExpenseCategory ec2 = new ExpenseCategory("Alojamiento", null);
			ExpenseCategory ec3 = new ExpenseCategory("Comida", null);
			ExpenseCategory ec4 = new ExpenseCategory("Otro", null);
			
//			combustible, alojamiento, entradas/tickets, comida,
